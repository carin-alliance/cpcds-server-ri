...
public class DebugEndpointController {
	...
	public ResponseEntity<String> updateClient(
			HttpServletRequest request, HttpEntity<String> entity, @RequestParam(name = "client_id") String clientId) {
		...
		if (OauthEndpointController.getDB().readClient(client.getId()) != null) {
			if (OauthEndpointController.getDB().updateClient(client)) return new ResponseEntity<>(HttpStatus.OK);
