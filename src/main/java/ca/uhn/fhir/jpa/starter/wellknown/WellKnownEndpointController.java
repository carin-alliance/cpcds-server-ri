...
public class WellKnownEndpointController {
	...
	public String getWellKnownJson(HttpServletRequest theRequest) {
		...
		wellKnownJson.put(
				WELL_KNOWN_AUTHORIZATION_ENDPOINT_KEY, AuthUtils.getOauthAuthorizationUrl(theRequest, appProperties));
		...
		wellKnownJson.put(
				WELL_KNOWN_INTROSPECTION_ENDPOINT, AuthUtils.getOauthIntrospectionUrl(theRequest, appProperties));
